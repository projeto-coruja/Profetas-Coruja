...
import br.unifesp.coruja.meta.general.Tuple;
...
public class CopyOfDTOUtility {
	...
	public CopyOfDTOUtility(String dtoPrefix, String entityPrefix, String dtoSuffix, String entitySuffix){
