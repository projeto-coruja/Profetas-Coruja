...
public class EntityManager {
     ...
     * 
     * @param table
     *            - Tabela que será feito a pesquisa.
     * @param criteria
     *            - String do critério (ex: profile = 'admin'). Usar "1=1" para
     *            retornar o número de entradas.
