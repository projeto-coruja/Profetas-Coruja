...
public class Regex {
	...
	/**
	 * Construtor.
	 * @param pattern - Expressão regular que será utilizado para a validação.
	 */
...
//		System.out.println(pattern);
	...
	/**
	 * Verifica se uma string está de acordo com a expressão regular.<br><br>
	 * Caso nenhum padrão seja passado anteriormente, o método irar utilizar as expressões pré-definidas. 
	 * @param string - String a ser verificado.
	 * @return <b>true</b> se a string estiver de acordo com a expressão regular.<br><b>false</b> caso contrário.
	 */
	public boolean check(String string){
		if(p == null || p.pattern() == null)	return findAN(string) || findN(string);
	 ...
	 * @param newPattern - Expressão regular.
	 */
