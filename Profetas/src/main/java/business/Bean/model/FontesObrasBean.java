...
public class FontesObrasBean {

	FontesObrasDAO dao;
	FontesObrasSearchDAO search;

	public FontesObrasBean() {
		dao = new FontesObrasDAO();
	}
	 ...
	 */
	public void addNewSourceWork (String titulo, String comentarios,
			...
			List<Personagem> personagens, List<Personagem> autoresCitados) throws UnreachableDataBaseException, DuplicateSourceWorkException {
