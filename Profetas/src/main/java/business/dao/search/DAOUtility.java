...
class DAOUtility {
    ...
    public static <T extends EntityModel> List<T> queryList(EntityManager manager, String table,
	    String field, Object info) throws UnreachableDataBaseException {
	try {
	    return manager.find("FROM " + table + " WHERE " + field + " = '" + info + "'"
		    + " ORDER BY id");
