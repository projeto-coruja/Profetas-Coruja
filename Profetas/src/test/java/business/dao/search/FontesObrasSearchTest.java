...
public class FontesObrasSearchTest {
	...
	FontesObrasSearchDAO dao = new FontesObrasSearchDAO();// pesquisa pela
							      // fonte/obra
	ClassificacaoSearchDAO dao2 = new ClassificacaoSearchDAO();

	Classificacao tipo = dao2.findExactClassificacao("matematica");

	List<FontesObras> lalala = dao.findFontesObrasByClassificacao(tipo.getId());
	for (FontesObras p : lalala) {
	...
	IdentifiedEntity tipo = (IdentifiedEntity) dao2
		.findExactGrupoMovimentoByNome("escola de pitagoras");
	...
	List<IdentifiedEntity> p = (List<IdentifiedEntity>) daoPersonagem
		.findExactPersonagemByExactNome("odisseu");
	System.out.println("depois");
	IdentifiedEntity o = dao.findExactFontesObrasById(1);
	for (IdentifiedEntity j : p) {
	    String query = ("FROM FontesObrasMO fontes INNER JOIN fontes.personagens list WHERE FontesObrasMO.id ="
		    + 1 + " AND list.id=" + 1);
	...
	personagens.add(new Personagem("hades", null, null, null, null, null, null, null, null,
		null, null, null, null, null, null));
	palavras.add(new PalavraChave("obra"));
	autores.add(new Personagem("ulisses", null, null, null, null, null, null, null, null, null,
		null, null, null, null, null));
	leitores.add(new Personagem("hercules", null, null, null, null, null, null, null, null,
		null, null, null, null, null, null));

	List<IdentifiedEntity> fontes = dao.mainSearchAND("O triangulo de pitagoras", "comentario",
		"nenhuma", "http://pt.wikipedia.org/wiki/Escola_pitag%C3%B3rica", "nenhuma",
		"italiano, portugues", dataimpressao, "nenhum", "escola de pitagoras",
		ano_inicioGrupo, ano_fimGrupo, "pai da matematica", "Grecia Central", 38.60, 22.71,
		"Grecia Central", 38.60, 22.71, "matematica", null, null, null, null, null);
	if (fontes != null) {
